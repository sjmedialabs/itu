      ...
      <div className="mx-auto w-full max-w-md">
        <Card className="overflow-hidden rounded-2xl border-neutral-200 shadow-lg">
          <CardHeader className="space-y-3 border-b border-neutral-100 bg-white pb-6 text-center">
            ...
            <CardTitle className="text-xl font-bold text-neutral-900">Staff sign in</CardTitle>
            <p className="text-sm text-neutral-500">
              Super admins and admins use email and password. You will be taken to the admin dashboard after a successful
              sign-in.
            </p>
          </CardHeader>
