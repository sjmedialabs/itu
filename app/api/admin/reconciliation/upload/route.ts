...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Run Centralized Security Pipeline (Magic-Bytes & Virus Scan) on payload content
    const payloadBuffer = Buffer.from(fileContent, typeof fileContent === 'string' && fileContent.startsWith('data:') ? 'base64' : 'utf-8')
